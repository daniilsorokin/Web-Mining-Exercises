...
if __name__ == '__main__':
    ...
    if params.b:
        ...
        input_data = scale_vectors(input_data, min_v, max_v)
    else:
        min_v, max_v = get_min_max(input_data)
        print(min_v[:10])
        print(max_v[:10])
        input_data = scale_vectors(input_data, min_v, max_v)
    ...
    save_as_csv(input_data, os.path.splitext(params.input_file)[0] + "_scaled.csv")
